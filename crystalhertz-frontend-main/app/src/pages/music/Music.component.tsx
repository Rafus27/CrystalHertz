...
export const MusicComponent: FC = () => {
    ...
    const testProps = [
        {
            ...
            description:
                "Lorem ipsum dolor sit amet consecteturnostrum impedit iste commodi fugit quae quas facilis ipsa doloremque!",
    ...
    return (
        <Music>
            ...
            <video
                ...
                muted
                loop
                style={{pointerEvents: "none", zIndex: -1, position: "absolute"}}
            >
                <source
            ...
            {token && (
                <MusicContainerSecond leftBarisOpen={leftBar.isOpen}>
                    <MusicContainerLeft>
                        <AddMusicComponent/>
                    </MusicContainerLeft>
                    ...
                    <MusicContainerCenter>
                        {testProps.map((item) => (
                            <SelectMusicComponent key={item.id} {...item} />
                        ))}
                    </MusicContainerCenter>
