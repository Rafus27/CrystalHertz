...
// data
import { dataLeftbarList, dataLeftbarListFooter } from "constants.tsx";
...
export const LeftBar: FC = () => {
  ...
  return (
    <LeftBarFrame isOpen={leftBar.isOpen}>
      <LeftBarContainer>
        <LeftBarImage
          onClick={() => dispatch(setBarIsOpen())}
          src={logoImg}
          alt="logo_white"
        />
