 ...
 */
export const dataNavbar: CurrentPage[] = [
  {
    key: "home",
    label: "Главная",
    status: false,
 ...
 */
export const dataLeftbarList: CurrentPage[] = [
  {
    key: "account",
    label: "Аккаунт",
    status: false,
...
export const dataLeftbarListFooter: CurrentPage[] = [
  {
    key: "questions",
    label: "Questions / Ask",
    status: false,
 ...
 * Descriptions...
 */
export const dataSettingButtonPage: SettingButton[] = [
  {
 ...
 * Descriptions...
 */
export const dataDefaultSortingValue: Sort[] = [
  {
    key: "listen",
    label: "Прослушивания",
  },
...
export const subsTexts = {
  descsMsg:
    "Подписка CRYSTAL+ позволяет вашим творениям появляться на главной странице намного чаще (шанс появления на главной возрастает на 30%).",
  descsMsg2:
    "Новым слушателям становится проще узнать о вас как о творце, и воодушевиться для работы над своими проектами.",
  policyAgreeMsg:
    "Являясь всего лишь частью общей картины, сторонники тоталитаризма в науке, которые представляют собой яркий пример континентально-европейского типа политической культуры, будут ограничены исключительно образом мышления. Наше дело не так однозначно, как может показаться: базовый вектор развития является качественно новой ступенью глубокомысленных рассуждений.",
};
